...
class doctor_patient(osv.osv):
	...
	_columns = {
		'attentions_pediatrics_ids': fields.one2many('doctor.attentions.pediatrics', 'patient_id', 'Atenciones Pediatría'),
	}
	...
	def atender_paciente_pediatria(self, cr, uid, ids, context=None):
		try:
